...
| 阶段 | 非精准采集下掉落 | 掉落物及概率 |
| :-- | :-- | :-- |
| <ItemImage id="data_energistics:small_data_crystal_bud" /> | <ItemImage id="data_energistics:data_dust" /> | 5% <ItemImage id="data_energistics:data_dust" /> |
...
| <ItemImage id="data_energistics:data_crystal_cluster" /> | <ItemImage id="data_energistics:data_crystal" /> | 1x <ItemImage id="data_energistics:data_crystal" />，受时运影响 |
