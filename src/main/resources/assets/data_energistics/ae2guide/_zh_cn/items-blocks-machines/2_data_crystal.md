...
| 阶段 | 非精准采集下掉落 | 掉落物及概率 |
| :-- | :-- | :-- |
| <ItemImage id="data_energistics:small_data_crystal_bud" /> | <ItemImage id="data_energistics:data_dust" /> | 10% <ItemImage id="data_energistics:data_dust" />，受时运影响 |
| <ItemImage id="data_energistics:medium_data_crystal_bud" /> | <ItemImage id="data_energistics:data_dust" /> | 25% <ItemImage id="data_energistics:data_dust" />，受时运影响 |
| <ItemImage id="data_energistics:large_data_crystal_bud" /> | <ItemImage id="data_energistics:data_dust" /> | 50% <ItemImage id="data_energistics:data_dust" />，受时运影响 |
| <ItemImage id="data_energistics:data_crystal_cluster" /> | <ItemImage id="data_energistics:data_dust" /> | 100% <ItemImage id="data_energistics:data_dust" />，受时运影响 |
