...
## 数据水晶母岩/块
它与赛特斯石英一样，随宇宙中的陨石而来。新生成的数位化陨石有 18 个母岩位置，每个位置独立抽取，五档数据水晶母岩都有机会出现；品质越高，生成概率越低。
...
| 母岩 | 每个陨石核心位置的概率 | 普通采集 | 精准采集 |
|---|---:|---|---|
| <ItemImage id="data_energistics:budding_data_crystal_0" /> 失活 | 11.75% | 无掉落 | 自身 |
| <ItemImage id="data_energistics:budding_data_crystal_1" /> 无能 | 10.75% | <ItemImage id="data_energistics:budding_data_crystal_0" /> 失活 | 自身 |
| <ItemImage id="data_energistics:budding_data_crystal_2" /> 疲劳 | 9.75% | <ItemImage id="data_energistics:budding_data_crystal_1" /> 无能 | 自身 |
| <ItemImage id="data_energistics:budding_data_crystal_3" /> 欠亏 | 8.75% | <ItemImage id="data_energistics:budding_data_crystal_2" /> 疲劳 | 自身 |
| <ItemImage id="data_energistics:budding_data_crystal_4" /> 充盈 | 4.00% | <ItemImage id="data_energistics:budding_data_crystal_2" /> 疲劳 | 自身 |

新分布仅影响新生成的数位化陨石，已有陨石与存档不会迁移。
