 ...
 */
final class DispatchCapacityPlannerImpl implements DispatchCapacityPlanner {

    private final Supplier<TrinityComputationCache> cache;
    private final CapacitySlicePlanner delegate;

    DispatchCapacityPlannerImpl(Supplier<TrinityComputationCache> cache, CapacitySlicePlanner delegate) {
