...
/** Production resolver that proves a hosted submission against the current preview definition generation. */
public final class TrinityAutoBuildSubmissionResolverImpl implements TrinityAutoBuildSubmissionResolver {

    /** Reconstructs the selection and rejects every field unsupported by the current atomic builder. */
    @Override
