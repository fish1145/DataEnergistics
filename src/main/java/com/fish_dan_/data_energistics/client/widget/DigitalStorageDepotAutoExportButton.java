...
public class DigitalStorageDepotAutoExportButton extends IconButton {
    ...
    public DigitalStorageDepotAutoExportButton(Consumer<DataExtractorAutoExportMode> onChange) {
        super(btn -> {
            if (btn instanceof DigitalStorageDepotAutoExportButton button) {
    ...
    public List<Component> getTooltipMessage() {
        return List.of(
                Component.translatable("button.data_energistics.digital_storage_depot.auto_export"),
                Component.translatable("button.data_energistics.digital_storage_depot.auto_export." + this.mode.getSerializedName()));
    }
}
