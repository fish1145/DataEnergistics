 ...
 *
 * <p>Implementations are client-main-thread confined so UI changes and network acknowledgements cannot race file
 * persistence.</p>
 */
public interface PatternEncodingClientPreferences {
     ...
     */
    int applyMissingLegacyValues(boolean uploadEnabled, boolean patternSourceEnabled,
