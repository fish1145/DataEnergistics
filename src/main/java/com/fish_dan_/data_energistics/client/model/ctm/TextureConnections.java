...
import static com.fish_dan_.data_energistics.client.model.ctm.OctagonalOrientation.*;
...
public class TextureConnections {
    ...
    protected Vector2ic[][] submapCache = copySubmaps(defaultSubmapCache);

    public static TextureConnections getInstance() {
        return new TextureConnections();
    }

    private static Vector2ic[][] copySubmaps(Vector2ic[][] source) {
        Vector2ic[][] copy = new Vector2ic[source.length][];
