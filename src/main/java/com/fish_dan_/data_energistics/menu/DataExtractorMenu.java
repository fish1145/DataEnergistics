...
public class DataExtractorMenu extends UpgradeableMenu<DataExtractorBlockEntity> implements IProgressProvider {
    ...
    @GuiSync(765)
    public int workIntervalSeconds = GameplayConfiguration.current().dataExtractor().workIntervalSeconds();
    @GuiSync(766)
    public int targetCount;
    @GuiSync(767)
    public int targetLimit = GameplayConfiguration.current().dataExtractor().baseTargetLimit();
    @GuiSync(768)
