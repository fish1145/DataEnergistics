...
public class DataNukeBlock extends TntBlock {

    public static final MapCodec<DataNukeBlock> CODEC = simpleCodec(DataNukeBlock::new);

    public DataNukeBlock(BlockBehaviour.Properties properties) {
        super(properties);
    }
    ...
    private static void prime(Level level, BlockPos pos, @Nullable LivingEntity igniter, int fuse) {
        ...
        DataNukePrimedEntity primed = new DataNukePrimedEntity(level, pos, igniter);
        primed.setFuse(fuse);
