...
import com.fish_dan_.data_energistics.integration.jei.ingredient.DataResourceAe2JeiIngredientConverter;
 ...
 */
final class Ae2JeiIngredientRegistration {
     ...
     */
    static synchronized void registerOnce() {
        if (registered) {
            return;
        }
