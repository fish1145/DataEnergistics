 ...
 *
 * <p>The bridge is enabled only for the duration of one {@code MEStorage#getAvailableStacks} call. It is implemented by
 * the KeyCounter Mixin and is intentionally not part of the external AE2 API.</p>
 */
