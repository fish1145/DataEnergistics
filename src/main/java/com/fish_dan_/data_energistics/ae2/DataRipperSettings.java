...
public final class DataRipperSettings {
    ...
    private static final Optional<VarHandle> AE2_SETTINGS_FIELD = ReflectionAccess.findStaticField(Settings.class, "SETTINGS");
    ...
    private static void registerAe2PacketSetting(Setting<?> setting) {
        Object value = ReflectionAccess.getField(AE2_SETTINGS_FIELD, null);
